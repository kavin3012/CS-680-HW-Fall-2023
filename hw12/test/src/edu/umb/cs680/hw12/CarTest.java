...
public class CarTest {
    ...
    public void carTest5WithPriceComparator() {
        ...
        Arrays.sort(unsorted, new PriceComparator());
    ...
    public void carTest5WithMileageComparator() {
        ...
        Arrays.sort(unsorted, new MileageComparator());
    ...
    public void carTest5WithYearComparator() {
        ...
        Arrays.sort(unsorted, new YearComparator());
    ...
    public void carTest5WithParetoComparator() {
        ...
        Arrays.sort(unsorted, new ParetoComparator());
